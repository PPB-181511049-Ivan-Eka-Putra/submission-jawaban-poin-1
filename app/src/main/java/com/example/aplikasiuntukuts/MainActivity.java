...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CheeseAdapter mCheeseAdapter = new CheeseAdapter();
    ...
    private static class CheeseAdapter extends RecyclerView.Adapter<CheeseAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            if (mCursor != null) {
                String cheeseItemName = mCursor.getString(mCursor.getColumnIndex(String.valueOf(position)));
                holder.mText.setText(cheeseItemName);
            } else {
